export default function VerticalLines() {
  return (
    ...
    >
      {/* Left side */}
      <div className="before:absolute before:inset-y-0 before:left-0 before:border-l before:[border-image:linear-gradient(to_bottom,theme(colors.cyan.300/.16),transparent)1] before:shadow-none after:absolute after:inset-y-0 after:left-20 after:border-l after:[border-image:linear-gradient(to_bottom,theme(colors.cyan.300/.16),transparent)1] after:shadow-none"></div>
      {/* Right side */}
      <div className="before:absolute before:inset-y-0 before:right-0 before:border-l before:[border-image:linear-gradient(to_bottom,theme(colors.cyan.300/.16),transparent)1] before:shadow-none after:absolute after:inset-y-0 after:right-20 after:border-l after:[border-image:linear-gradient(to_bottom,theme(colors.cyan.300/.16),transparent)1] after:shadow-none"></div>
    </div>
  );
}
